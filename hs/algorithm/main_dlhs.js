...
async function testDLHS() {
  ...
  projectGeneralSheet.addRow(['ID_KPI_Target', 'Target A'
    // , 'Target B', 'Target C'
  ])
  projectGeneralSheet.addRow([project.kpiTarget['A'].value
    // , project.kpiTarget['B'].value, project.kpiTarget['C'].value
  ])
  ...
  const filePath = '/Users/gioi/Documents/learn/hust/datn/gr2/GR2/hs/ouput/dlhs_task_kpis_output_logs.xlsx';
  await workbook.xlsx.writeFile(filePath);
}

testDLHS()
console.log(`Excel file created ./output/dlhs_task_kpis_output.xlsx`);
